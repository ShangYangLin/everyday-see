...
const TRANSLATIONS = {
  zh: {
    ...
    aboutTitle: "關於每天見",
    aboutBody: "每天見，是專為高齡長者設計的陪伴遊戲。我們相信，記憶或許會褪色，但陪伴的心意不會。透過每天幾分鐘的翻牌遊戲，搭配家人的真實照片與重要的生活提醒，希望能陪長輩多留住一些珍貴的片刻，也讓在外的家人，多一個每天惦記彼此的理由。",
    settingsTitle: "設定",
    ...
    contactEmailAddress: "seeyoueveryday.support@gmail.com",
